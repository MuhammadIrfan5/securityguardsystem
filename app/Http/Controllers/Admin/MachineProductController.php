...
class MachineProductController extends Controller
{
    ...
    {
        $data['activeMenu'] = 'Machine Product';
        return view('admin.machineproduct.table', $data);
    }
...
//        }
        ...
        foreach ($country as $record) {
            $response['data'][] = [
                ...
                $record->machineId->machine_serial_no,
                $record->productId->title,
    ...
    {
        $data['activeMenu'] = 'Add Machine-Product';
        $data['machine'] = Machine::all();
        $data['product'] = Product::all();
        return view('admin.machineproduct.add', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $country = new MachineProduct();
        $country['machine_id'] = $request->machine_id;
        $country['product_id'] = $request->product_id;
        $country['production_capacity'] = $request->production_capacity;
        $country['capacity_unit'] = $request->capacity_unit;
        $country->save();
        Session::flash('message', 'Machine Product Added successfully');
        return redirect(route('machine-product.index'));
    }
