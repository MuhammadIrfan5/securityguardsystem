...
class UnitShiftController extends Controller
{
    ...
    {
        $data['activeMenu'] = 'Units Shift ';
        return view('admin.unitshift.table',$data);
    }
...
//        }
    ...
    {
        $data['activeMenu'] = 'Add Units Shift';
        $data['units']=Unit::all();
        return view('admin.unitshift.add',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $country['shift_title'] = $request->shift_title;
        $country['start_time'] = $request->start_time;
        $country['end_time'] = $request->end_time;
        $country->save();
        Session::flash('message', 'Unit Shift Added successfully');
        return redirect(route('units-shift.index'));
    }
